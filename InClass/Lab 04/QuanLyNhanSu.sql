...
VALUES (
        'CN01',
        'Hà Nội',
        '76 Nguyễn Công Phương, Q.Hoàng Mai',
        'CT01'
    ), (
        'CN02',
        'Đà Lạt',
...
VALUES (
        'CT01',
        'Thế Giới Di Động',
        '125 Lê Văn Việt, Q.Thủ Đức, TP HCM'
    ), (
        'CT02',
        'CellPhoneS',
        '16 Hùng Vương, Q.Cầu Giấy, Hà Nội'
    ), (
        'CT03',
        'Viễn Thông A',
        '136 Nguyễn Thái Học, Q.1, TP HCM'
    );
...
VALUES ('PB01', 'Marketing', 'CN01'), ('PB02', 'Nhân sự', 'CN01'), ('PB03', 'Marketing', 'CN02'), ('PB04', 'Nhân sự', 'CN02');
...
ALTER TABLE `CONGTY` ADD PRIMARY KEY (`MaCongTy`);
...
ALTER TABLE `CHINHANH`
ADD
    CONSTRAINT `CHINHANH_ibfk_1` FOREIGN KEY (`MaCongTy`) REFERENCES `CONGTY` (`MaCongTy`);
...
ALTER TABLE `NHANVIEN`
ADD
    CONSTRAINT `NHANVIEN_ibfk_1` FOREIGN KEY (`MaPhong`) REFERENCES `PHONGBAN` (`MaPhong`);
...
ALTER TABLE `PHONGBAN`
ADD
    CONSTRAINT `PHONGBAN_ibfk_1` FOREIGN KEY (`MaChiNhanh`) REFERENCES `CHINHANH` (`MaChiNhanh`);
